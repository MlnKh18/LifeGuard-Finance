...
- **Surface (Dark Slate):** The foundational background color. 
- **Surface Tint:** All elevated surfaces receive a subtle teal-tinted overlay proportional to their elevation level, following M3 logic.
